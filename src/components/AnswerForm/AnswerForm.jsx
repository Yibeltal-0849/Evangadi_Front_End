...
const AnswerForm = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://evangadi-api-question-answer.onrender.com/api/questions/${questionId}/answers`,
        {
          method: "POST",
          headers: {
  ...
  const handleUpdateAnswer = async () => {
    ...
    try {
      const response = await fetch(
        `https://evangadi-api-question-answer.onrender.com/api/${editingAnswerId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDeleteAnswer = async (answerId) => {
    ...
    try {
      const response = await fetch(
        `https://evangadi-api-question-answer.onrender.com/api/${answerId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  return (
    <section className={classes.answerFormWrapper}>
      ...
      <Link to="/questions" className={classes.page}>
        Go to Question page
      </Link>
