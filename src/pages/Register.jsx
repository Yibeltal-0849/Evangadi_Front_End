...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        // "https://evangadi-api.digitalyibeltal.com/api/users/register",
        "https://evangadi-api-question-answer.onrender.com/api/users/register",
        payload,
        {
          headers: {
            "Content-Type": "application/json",
        ...
        <form onSubmit={handleSubmit} className={classes.form}>
          ...
          <div className={classes.checkbox__group}>
            ...
            <label className={classes.terms}>
              I agree to the{" "}
              <Link to="/privacy-policy" className={classes.pp_terms}>
                privacy policy
              </Link>{" "}
              and{" "}
              <Link to="/terms" className={classes.pp_terms}>
                terms of service
              </Link>
              .
            </label>
