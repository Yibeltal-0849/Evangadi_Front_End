...
const AdminQuestionManagement = () => {
  ...
  const fetchQuestions = async () => {
    try {
      ...
      const response = await axios.get(
        "https://evangadi-api-question-answer.onrender.com/api/admin/questions",
        {
          headers: {
  ...
  const handleDelete = async (questionId) => {
    if (
      ...
      try {
        const token = localStorage.getItem("token");
        await axios.delete(
          `https://evangadi-api-question-answer.onrender.com/api/admin/questions/${questionId}`,
          // `https://evangadi-api-question-answer.onrender.com/api/admin/questions/${questionId}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.put(
        `https://evangadi-api-question-answer.onrender.com/api/admin/questions/${editingQuestion.question_id}`,
        editForm,
        {
          headers: {
            Authorization: `Bearer ${token}`,
