  ...
  const fetchData = async () => {
    ...
    try {
      const [statsRes, questionsRes] = await Promise.all([
        axios.get("https://evangadi-api-question-answer.onrender.com/api/admin/stats", 
        ...
        axios.get("https://evangadi-api-question-answer.onrender.com/api/admin/recent-questions",
