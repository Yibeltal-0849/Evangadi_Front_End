...
const QuestionAnswerList = () => {
    ...
    const fetchQuestionsWithAnswers = async () => {
      try {
        const [questionsRes, userRes] = await Promise.all([
          axios.get(
            "https://evangadi-api-question-answer.onrender.com/api/admin/question-full",
            {
              headers: {
          ...
          axios.get(
            "https://evangadi-api-question-answer.onrender.com/api/users/checkUser",
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
  ...
  const handleSaveEdit = async (answerId) => {
    try {
      await axios.put(
        `https://evangadi-api-question-answer.onrender.com/api/admin/answers/${answerId}`,
        {
